...
- ⭐ **Jellyfin and Emby libraries pair properly.** `Show - 01.Japanese.srt`
  ...
  `Show - 01.Japanese.forced.srt` keeps its forced flag, which it also used to
  lose. *(Reported by the [hato](https://github.com/SonicSandbox) project.)*
